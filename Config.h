...
#define AXIS_HARDWARE_TIMER_BASE 2        //         ESP32-C6: HW timer 1 → sidereal clock, HW timer 2 → AXIS1 motor, AXIS2 → SW task
...
#define AXIS1_TARGET_TOLERANCE       60.0 //    0.0, n. (arc-seconds) Goto stops when AZ is within this of target.            Adjust
                                          //         Prevents 15s timeout when near-polar targets have a fast-moving AZ coord.
...
#define AXIS2_TARGET_TOLERANCE       30.0 //    0.0, n. (arc-seconds) Goto stops when ALT is within this of target.           Adjust
