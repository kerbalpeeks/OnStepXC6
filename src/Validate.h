...
// AXIS1 RA/AZM
    ...
    (AXIS1_DRIVER_MODEL < UNI_DRIVER_FIRST || AXIS1_DRIVER_MODEL > UNI_DRIVER_LAST) && \
    (AXIS1_DRIVER_MODEL < RC_SERVO_DRIVER_FIRST || AXIS1_DRIVER_MODEL > RC_SERVO_DRIVER_LAST)
  #error "Configuration (Config.h): Setting AXIS1_DRIVER_MODEL unknown, use OFF or a valid DRIVER (from Constants.h)"
#endif
#if defined(AXIS1_RC_SERVO_PRESENT) && AXIS1_SERVO_PIN == OFF
  #error "Configuration (Config.h): AXIS1_SERVO_PIN must be set to a valid GPIO when AXIS1_DRIVER_MODEL is SERVO_RC"
#endif
...
// AXIS2 DEC/ALT
    ...
    (AXIS2_DRIVER_MODEL < UNI_DRIVER_FIRST || AXIS2_DRIVER_MODEL > UNI_DRIVER_LAST) && \
    (AXIS2_DRIVER_MODEL < RC_SERVO_DRIVER_FIRST || AXIS2_DRIVER_MODEL > RC_SERVO_DRIVER_LAST)
  #error "Configuration (Config.h): Setting AXIS2_DRIVER_MODEL unknown, use a valid DRIVER (from Constants.h)"
#endif
#if defined(AXIS2_RC_SERVO_PRESENT) && AXIS2_SERVO_PIN == OFF
  #error "Configuration (Config.h): AXIS2_SERVO_PIN must be set to a valid GPIO when AXIS2_DRIVER_MODEL is SERVO_RC"
#endif
