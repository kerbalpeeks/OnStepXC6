...
#elif defined(AXIS1_RC_SERVO_PRESENT)
  RcServoMotor motor_1(1, AXIS1_REVERSE, AXIS1_SERVO_PIN, (float)AXIS1_STEPS_PER_DEGREE);
...
#elif defined(AXIS2_RC_SERVO_PRESENT)
  RcServoMotor motor_2(2, AXIS2_REVERSE, AXIS2_SERVO_PIN, (float)AXIS2_STEPS_PER_DEGREE);
